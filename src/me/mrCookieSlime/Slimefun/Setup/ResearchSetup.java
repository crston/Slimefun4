...
public class ResearchSetup {
	...
	public static void setupResearches() {
	    ...
	    Slimefun.registerResearch(new Research(129, "Delicious Drinks", 29), SlimefunItems.JUICER, SlimefunItems.APPLE_JUICE, SlimefunItems.MELON_JUICE, SlimefunItems.EASTER_CARROT_JUICE, SlimefunItems.PUMPKIN_JUICE);
